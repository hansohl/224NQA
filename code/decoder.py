...
def LSTMNode(h, c, u, scope, hidden_size = 200, l = 200):
    with tf.variable_scope(scope) as scope:
        Wi = tf.get_variable("Wi", [2 * l, hidden_size], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32)
        ...
        Wf = tf.get_variable("Wf", [2 * l, hidden_size], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32)
        ...
        Wo = tf.get_variable("Wo", [2 * l, hidden_size], initializer=tf.contrib.layers.xavier_initializer(), dtype=tf.float32)
        ...
        Wc = tf.get_variable("Wc", [2 * l, hidden_size], initializer=tf.contrib.layers.xavier_initializer())
...
class Decoder(object):
    ...
    def decode(self, knowledge_rep, masks, batch_size, iters = 4, hidden_size = 200, l = 200):
        """
